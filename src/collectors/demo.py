...
class DemoData:
    def __init__(self,calendar,as_of,stage):
        ...
        day=as_of.date() if stage in ('1600','2130','1135','2200','1200') else calendar.previous(as_of.date())
        self.day=day
        ...
        for i,u in enumerate(self.universe):
            ...
            if stage in ('1135','1200'): frame.loc[len(frame)-1,'timestamp']=datetime.combine(day,datetime.min.time()).replace(hour=11,minute=30,tzinfo=TZ)
